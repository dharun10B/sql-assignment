		...
		/* Create a table Empl to store employee details */
	...
	/* write a query to Display employee name and salary of those whose salary is in the range of 2500 to 4000 */
	...
	/* write a query to Display the name of the employee whose name contains 'A' as the third alphabet	*/
 
	select Ename from Empl where Ename like "__A%";
									
			Empty set (0.00 sec)
	
	/* write a query to Display the name of the employee whose name contains 'T' as the last alphabet */
	...
	/* write a query to Display the name of the employee whose name contains 'M' as the first and 'L' as the third alphabet */								
	...
	/* write a query to Display details of employees with the text 'Not given' if the commission is NULL */
			...
			SELECT * FROM empl WHERE comm IS NULL AND job = 'Not given';
